...
title: 生活
type: landing
summary: 博客、旅行计划、爱好，以及我的书籍与电影收藏。
sections:
  - block: markdown
    content:
      title: '🌤️ 生活'
      ...
      text: |
        ...
        <div class="wide-grid" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:16px;">
          ...
          <a href="https://books.caotianyu.com" style="display:block;background:var(--card,#fff);border:1px solid var(--line,#e7e0d4);border-radius:14px;padding:22px 24px;text-decoration:none;color:inherit;">
            <div style="font-weight:700;font-size:16px;">📚 书籍</div>
            <div style="color:#6b6255;font-size:13px;margin-top:6px;">访客账号只读，见页面说明</div>
          </a>

          <div style="display:block;background:var(--card,#fff);border:1px dashed var(--line,#e7e0d4);border-radius:14px;padding:22px 24px;opacity:0.6;">
            <div style="font-weight:700;font-size:16px;">🎬 电影</div>
            <div style="color:#6b6255;font-size:13px;margin-top:6px;">筹备中，稍后开放访客入口</div>
          </div>
